...
RcppExport SEXP _mdmb_mdmb_test_rtnorm3(SEXP muSEXP, SEXP sigmaSEXP, SEXP lowerSEXP, SEXP upperSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< double >::type mu(muSEXP);
    ...
    Rcpp::traits::input_parameter< double >::type lower(lowerSEXP);
    Rcpp::traits::input_parameter< double >::type upper(upperSEXP);
    rcpp_result_gen = Rcpp::wrap(mdmb_test_rtnorm3(mu, sigma, lower, upper));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_mdmb_mdmb_test_rtnorm3", (DL_FUNC) &_mdmb_mdmb_test_rtnorm3, 4},
    {NULL, NULL, 0}
};
